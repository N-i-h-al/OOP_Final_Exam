    ...
    def take_loan(self, unique_id):
        if unique_id in self.clients:
            ...
            if self.loan_feature_enabled:
                ...
                print("Loan feature is currently disabled Now.")
        else:
            print("Account does not exist.")
...
Banking_Mechanism.admin_check_total_balance()
Banking_Mechanism.admin_check_total_loan_amount()
Banking_Mechanism.admin_enable_loan_feature()
Banking_Mechanism.admin_disable_loan_feature()
